						...
						<div class="row uniform 50%">
							<div class="6u 12u$(xsmall)">
								<input type="text" name="title" id="title" placeholder="title"
									value="${set.title }"
									style="font-family: 'a고래야놀자'; color: black; border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;" />
							</div>
							<div class="6u$ 12u$(xsmall)">
							...
							<div class="12u$">
								...
								value="${set.text }"
									style="font-family: 'a고래야놀자'; color: black; border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;"></textarea>
							</div>
							<div class="12u$">
						...
						<div class="row uniform 50%">
							...
							<div class="12u$">
								<textarea name="message" id="message" placeholder="Message"
									rows="8" style="font-family: 'a고래야놀자'; color: black; border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;"></textarea>
							</div>
							<div class="12u$">
								<input type="submit" value="Send Message"
									style="font-family: 'a고래야놀자'; color: black; border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;" />
