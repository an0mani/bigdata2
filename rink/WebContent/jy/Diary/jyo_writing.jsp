		...
		<div class="8u 12u$(small)">
			<c:choose>
				...
				<div class="row uniform 50%">
					...
					<div class="6u 12u$(xsmall)">
						<input type="date" name="date" id="date" value="${set.date }" placeholder="date" style = "font-family: 'a고래야놀자'; color:black;  border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;"/><br>
					</div>
					<div class="6u$ 12u$(xsmall)">
				...
				<div class="row uniform 50%">
					...
					<div class="6u 12u$(xsmall)">
						<input type="date" name="date" id="date" placeholder="date" style = "font-family: 'a고래야놀자'; color:black;  border:1px solid #A6A6A6; border-width:3px 3px 3px 3px;"/><br>
					</div>
					<div class="6u$ 12u$(xsmall)">
