...
<body id="top">
	...
	<div class="inner1" style="margin-top: 40px">
		...
		<input type="button" value='' onclick = "changeIframeUrl('writing.jsp')" style="width: 50px; height: 50px; min-width: 6em !important; font-size: 15px; text-align: center; color: black !important; margin-right: 0px; font-family: 'a고래야놀자'"></input><br>
		<input type="button" value='어린이 뉴스' onclick = "changeIframeUrl('README.txt')" style="width: 50px; height: 50px; min-width: 6em !important; font-size: 15px; text-align: center; color: black !important; margin-right: 0px; font-family: 'a고래야놀자'"></input>
		...
		<table>
			...
			<tr>
				...
				<td><input type="button" value='발달시기별 ' onclick = "changeIframeUrl('Notice1.jsp')"></input></td>
				<td>2</td>
				<td>3</td>
				<td>4</td>
			<tr>
			...
			<input type="button" value='발달시기별 ' onclick = "changeIframeUrl('Notice1.jsp')"></input>
			<input type="button" value='발달시기별 ' onclick = "changeIframeUrl('Notice1.jsp')"></input>
