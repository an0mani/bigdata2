...
<body id="top">
	...
	<div id="main" style="margin-left: 380px;padding-top: 0px;padding-bottom: 50px;padding-left: 50px;padding-right: 0px;border-bottom-width: 100px;">
		...
		<div style="height: 500px;width: 100%;"><iframe src="http://olapopendata.hira.or.kr/analysis/desktop/poc2.jsp#report_id=b235b0f3-24cb47fe&amp;PARAM1=" frameborder="0" width="100%" height="100%" class="olapViewFrame"></iframe></div>
			...
			<div><h1>자주걸리는 질병 리스트</h1></div>
			<h1 align = "center">1.감기</h1><br>
			<img src="back_image/20.jpg" style="width: 500px; height:500px;"><br>
			...
			<h2>[예방법]</h2>
			<h2>① 손을 자주 씻어 손에 묻어 있을 수 있는 감기 바이러스를 없애고<br>② 손으로 눈이나 코, 입 등을 비비거나 만지지 않도록 합니다.<br>③ 또한 수건 등의 일상 용품을 다른사람들과 함께 쓰지 않는것이 좋습니다.<br>④ 기침을 할때에는 손으로 가리지 않고 머리를 아래로 숙여서 바닥을 향하도록 합니다.<br>⑤ 어린이는 성인에 비해 면역력이 낮아 감기 바이러스에 감염될 확률이 높으므로 인원이 너무 많은 곳은 피하도록 합니다.</h2>
			<br>
			<h1 align = "center">2.인두 / 편도선염</h1><br>
			...
			<h1 align = "center">3.식중독 및 장염</h1><br>
			...
			<h1 align = "center">5.알레르기성 비염</h1><br>
